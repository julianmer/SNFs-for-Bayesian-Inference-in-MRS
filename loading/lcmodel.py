...
if __name__ == '__main__':
    ...
    parser_make_basis.add_argument('--path2basis', type=str, help='Path to the basis set to be saved.', default=None)
    ...
    if args.command == 'make_basis':
        ...
        print('Invalid command! Enter one of the following commands: make_basis')
