...
from simulation.simulation import simulateParam, simulateRW, simulatePeaks, normParams, normConcs
...
class SynthDataModule(pl.LightningDataModule):
    ...
    #   initialize instance   #
    #*************************#
    def __init__(self, basis_dir, nums_test, sigModel=None, params=normParams, concs=normConcs,
    ...
    def get_batch(self, batch):
        ...
        if 'numPeaks' in self.params and 'peakAmp' in self.params and \
            ...
            for i in range(batch):
                if nums[i] > 0:
                    ...
                    amps, widths, phases = simulatePeaks(nums[i], self.params)
        ...
        return spec, cleanSpec, torch.from_numpy(theta)
...
class ChallengeDataModule(pl.LightningDataModule):
    ...
    #*************************#
    def __init__(self,
                 data_dir='../Data/DataSets/2016_MRS_fitting_challenge/datasets/datasets_JMRUI_WS/',
                 basis_dir='../Data/DataSets/2016_MRS_fitting_challenge/basis_sets/basisset_JMRUI/',
                 truth_dir='../Data/DataSets/2016_MRS_fitting_challenge/ground_truth',
